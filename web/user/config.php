...
if ( ! isset( $_ENV['YOURLS_DB_HOST'] ) ) {
	$_ENV['YOURLS_DB_HOST'] = 'localhost';
}

if ( ! isset( $_ENV['YOURLS_URL_CONVERT'] ) ) {
	$_ENV['YOURLS_URL_CONVERT'] = 62;
}

if ( ! isset( $_ENV['YOURLS_UNIQUE_URLS'] ) ) {
	$_ENV['YOURLS_UNIQUE_URLS'] = false;
}

if ( ! isset( $_ENV['YOURLS_DB_PREFIX'] ) ) {
	$_ENV['YOURLS_DB_PREFIX'] = 'yourls_';
}
...
$yourls_user_passwords = array(
	$_ENV['ENV_USER'] => $_ENV['ENV_PASSWORD'],
	// 'username2' => 'password2',
